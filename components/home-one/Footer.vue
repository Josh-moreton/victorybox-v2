...
import bannerCar3 from "/images/banner/banner-car3.png";
import chnagingIcon from "/images/global/chnaging-icon.png";
</script>
<template>
          ...
          <div class="col-lg-6">
            <div class="footer-content1">
              <div class="d-flex align-items-center gap-xxl-3 gap-2 mb-xxl-24 mb-4">
                <NuxtImg :src="chnagingIcon" alt="img" />
                <span class="nw1-clr fw_700 fs20"> Chasing Fortunes </span>
              </div>
              <div class="section__title mb-xxl-15 mb-xl-10 mb-8">
                <span class="display-one d-block n0-clr">
                  Explore
                  <span class="d-flex align-items-center gap-2">
                    <span class="d-block" data-aos="zoom-in-right" data-aos-duration="1200"> Our </span>
              ...
              <div class="say-helow pb-xxl-5 pb-5 d-flex flex-wrap gap-3 align-items-center justify-content-between">
                <div class="mails">
                  <span class="nw4-clr d-block mb-xxl-2 mb-0"> Say Hello </span>
                  <NuxtLink to="#" class="fs20 fw_600 nw1-clr"> cruz@example.com </NuxtLink>
                </div>
                <NuxtLink to="/contest" class="kewta-btn d-inline-flex align-items-center">
                  <span class="kew-text p1-bg n4-clr">
                    Participant Now
                    <PhArrowUpRight class="ph-bold ph-arrow-up-right n4-clr"></PhArrowUpRight>
                  </span>
                </NuxtLink>
              </div>
            </div>
          ...
          <div class="col-lg-5">
            <div class="footer-thumbv1-wrap">
              <div class="footer-browse-btn">
                <NuxtLink to="#" class="cmn__collection radius-circle act4-bg d-center position-relative">
                  <span class="cmn-cont-box text-center position-relative">
                    ...
                    <span class="d-block n0-clr fw_700"> Explore Now </span>
                  </span>
                </NuxtLink>
              </div>
              ...
              <MotionEffectMotionFadeRight class="footer-thumb1" data-aos="fade-down-left" data-aos-duration="1500">
                <NuxtImg :src="bannerCar3" alt="img" />
    ...
    <div class="footer-botttom cmn-bb pb-xxl-8 pb-xl-6 pb-4 position-relative cus-z1">
      <div class="container">
        <div class="d-flex flex-wrap gap-4 align-items-center justify-content-md-between justify-content-center">
          <ul class="linkfooter flex-wrap justify-content-center">
            <li>
            ...
            <li>
              <NuxtLink to="/blog1"> Our Blog </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/winners"> Winners List </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/contact"> Contact Us </NuxtLink>
            </li>
          </ul>
          <ul class="social d-flex align-items-center gap-3">
            <li>
              <NuxtLink to="#">
      ...
      <div class="container">
        <div class="d-flex flex-wrap gap-3 align-items-center justify-content-md-between justify-content-center">
          <ul class="pri-link d-flex align-items-center gap-xxl-6 gap-sm-6 gap-3">
            <li>
              <NuxtLink to="#"> Terms & Service </NuxtLink>
            </li>
            <li>
          ...
          <p class="footer-copyright flex-wrap justify-content-center">
            <span class="copy n0-clr"> Copyright &copy; 2024 <NuxtLink to="#">Lottovibe</NuxtLink> </span>
