...
<template>
  <footer class="footer-section4 n4-bg position-relative cus-z1 overflow-hidden">
    <div class="container pt-120 pb-120">
      <div class="row g-6 justify-content-between align-items-center">
        <div class="col-lg-5">
          <div class="destination-cont-left footer-lottovibe-newsv7">
            <NuxtLink to="#" class="d-block mb-xxl-6 mb-lg-4 mb-3">
              <NuxtImg :src="logoWhite" alt="img" />
            </NuxtLink>
            <p class="nw4-clr fs18 mb-xxl-10 mb-xxl-8 mb-6">Lottery games are meant entertaining and enjoyable. If you or someone you have a gambling problem,</p>
            <h4 class="fw_600 nw1-clr d-block mb-xxl-5 mb-xl-4 mb-3">Subscribe to our newsletter</h4>
            <div class="gap-xl-6 gap-lg-4 gap-sm-3 gap-2" data-aos="fade-up" data-aos-duration="1800">
              <form class="box-address box-addressv7">
                <input type="text" placeholder="Enter your email address" />
                <button type="submit" class="p1-bg mt-xxl-10 mt-xl-8 mt-lg-6 mt-5 fs20 fw_700 w-100 n4-clr py-xxl-4 py-xl-3 py-2 px-2 radius100">Get Started</button>
              </form>
            </div>
          </div>
        </div>
        <div class="col-lg-7">
          <div class="footer-explore-v7">
            <MotionFadeTopToDown class="display-two n0-clr">
              <div class="d-flex align-items-center gap-xl-4 gap-3">
                EXPLORE
                <NuxtLink to="/contact" class="kewta-btn cmn-60 d-inline-flex align-items-center justify-content-center">
              ...
              <span> OUR <span class="act4-clr">LOTTERY</span> </span>
            </MotionFadeTopToDown>
            <div class="jewellery-custom-tablet">
    ...
    <div class="footer-bottomv4 py-xxl-8 py-xl-6 py-lg-4 py-sm-2 py-0">
      <div class="container">
        <div class="row g-6 align-items-center justify-content-between">
          ...
          <div class="col-lg-5 col-md-5">
            <div class="footer-bottom-cont1 d-flex align-items-center justify-content-md-end justify-content-center h-100">
