...
import nextDrawv7thumb from "/images/banner/next-drawv7-thumb.png";
import nextDrawv7 from "/images/banner/next-drawv7.png";
import how1Arrow from "/images/global/how1-arrow.png";

const deadline = "April 20, 2025"; // Follow this format: "MM/DD/YYYY"
const { days, hours, minutes, seconds } = useCountdownTwo(deadline);
</script>
<template>
  <section class="next-draw-sectionv4 next-draw-positonv4">
    <div class="container">
      <div class="draw-nextwrap-v4wrap d-flex justify-content-center align-items-xl-end align-items-center">
        <div class="draw-netwrap-inner draw-nextwrapinnerv7">
          <div class="thumb">
            <NuxtImg :src="nextDrawv7thumb" alt="img" />
          </div>
          <div class="right-side-nextdraw">
            <div class="draw-countdraw text-center position-relative">
              <NuxtImg :src="how1Arrow" alt="img" class="next-arrow" />
              <h2 class="fw_800 n4-clr mb-xxl-8 mb-5">Next Draw</h2>
            ...
            <div class="watch-live-wrap">
              <div class="watch-thumb cmn-width">
                <NuxtImg :src="nextDrawv7" alt="img" class="radius-circle" />
              </div>
              <NuxtLink to="#" class="draw-watch cmn-width d-flex align-items-center justify-content-center">
                <span>
                  ...
                  <span class="watch-text">
                    <svg width="68" height="149" viewBox="0 0 68 149" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path
                        d="M58.4303 68.5628L60.3123 68.3886L60.5081 70.5035L58.6261 70.6778L58.4303 68.5628ZM47.6733 69.7214L56.4199 68.9116L56.5875 70.7219L47.8409 71.5317L47.6733 69.7214Z"
                        fill="white"
                      />
