...
import { PhArrowUpRight, PhEnvelopeSimple, PhMapPin, PhPhoneCall } from "@phosphor-icons/vue";
import footerLogo3 from "/images/logo/footer-logov3.png";
</script>
<template>
        ...
        <div class="col-lg-6 col-md-7">
          <div class="destination-cont-left">
            <div class="box mb-xxl-15 mb-xl-10 mb-md-8 mb-sm-4 mb-2">
              <h4 class="fw_700 nw1-clr mb-xxl-5 mb-3" data-aos="zoom-in-left" data-aos-duration="1200">Your Lottery Adventure Awaits</h4>
              <span class="display-three nw1-clr" data-aos="zoom-in-right" data-aos-duration="1400"> Lottery Destination </span>
            </div>
            <div class="d-flex align-items-center gap-xl-6 gap-lg-4 gap-sm-3 gap-2" data-aos="fade-up" data-aos-duration="1800">
              ...
              <NuxtLink to="#" class="cmn-60 d-center p1-bg radius-circle">
                <PhArrowUpRight weight="bold" class="ph-bold ph-arrow-up-right n4-clr fs-four"></PhArrowUpRight>
              </NuxtLink>
            </div>
          </div>
        </div>
          ...
          <div class="footer-v4cont-info">
            <div class="fv4-cont-item d-flex align-items-center gap-xxl-4 gap-lg-3 gap-2" data-aos="zoom-in-up" data-aos-duration="1200">
              <div class="icon cmn-60 radius-circle d-center">
                <PhMapPin weight="bold" class="ph-bold ph-map-pin fs-four p1-clr"></PhMapPin>
              </div>
              <div class="cont">
                <NuxtLink to="#" class="nw1-clr fs20 fw_600"> 2464 Royal Ln. Mesa New Jersey 45463 </NuxtLink>
              </div>
            </div>
            <div class="fline" data-aos="zoom-in-up" data-aos-duration="1200"></div>
            <div class="fv4-cont-item d-flex align-items-center gap-xxl-4 gap-lg-3 gap-2" data-aos="zoom-in-up" data-aos-duration="1200">
              <div class="icon cmn-60 radius-circle d-center">
                <PhEnvelopeSimple weight="bold" class="ph-bold ph-envelope-simple fs-four p1-clr"></PhEnvelopeSimple>
              </div>
              <div class="cont">
                <span class="nw1-clr d-block fs-seven mb-2">Email Us Directly</span>
                <NuxtLink to="#" class="nw1-clr fs20 fw_600"> cruz@example.com </NuxtLink>
              </div>
            </div>
            <div class="fline" data-aos="zoom-in-up" data-aos-duration="1200"></div>
            <div class="fv4-cont-item d-flex align-items-center gap-xxl-4 gap-lg-3 gap-2" data-aos="zoom-in-up" data-aos-duration="1200">
              <div class="icon cmn-60 radius-circle d-center">
                <PhPhoneCall weight="bold" class="ph-bold ph-phone-call fs-four p1-clr"></PhPhoneCall>
              </div>
              <div class="cont">
                <NuxtLink to="#" class="nw1-clr fs20 fw_600">
                  <span class="nw1-clr d-block fs-seven mb-2">Call Us Directly</span>
                  (603) 555-0123
                </NuxtLink>
              </div>
            </div>
    ...
    <div class="footer-bottomv4 py-6 py-lg-0">
      <div class="container">
        <div class="row g-6 justify-content-between">
          <MotionEffectMotionFade class="col-lg-4 col-md-4 col-sm-6">
            <div class="footer-bottom-cont1 d-flex justify-content-sm-start justify-content-center align-items-center h-100 py-xxl-8 py-xl-6 py-lg-4 py-sm-2 py-0">
              <span class="copy nw4-clr">
                Copyright &copy; 2024
                <NuxtLink to="#" class="nw4-clr"> Lottovibe </NuxtLink>
                <span class="designed nw4-clr d-block mt-2">
                  Designed By
                  <NuxtLink to="https://themeforest.net/user/pixelaxis" class="p1-clr"> Pixelaxis </NuxtLink>
                </span>
              </span>
            </div>
          </MotionEffectMotionFade>
          <MotionEffectMotionFade class="col-lg-3 col-md-3 col-sm-6">
            <div class="footer-bottom-cont1 d-flex align-items-center h-100 py-xxl-8 py-xl-6 py-lg-4 py-sm-2 py-0 px-4 b-one border-start border-end">
              <NuxtLink to="/" class="footer-logov4 text-center m-auto d-block">
                <NuxtImg :src="footerLogo3" alt="img" />
              </NuxtLink>
            </div>
          </MotionEffectMotionFade>
          <MotionEffectMotionFade class="col-lg-5 col-md-5">
