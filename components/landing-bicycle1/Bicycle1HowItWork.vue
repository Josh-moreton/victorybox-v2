...
import stepDot from "/images/global/step-dot.png";
...
<template>
  <section :class="`howit-work-sectionv5 position-relative  pt-120 pb-120 ${sectionBg ? '' : 'winbg'}`">
    <!-- {/* Section Header */} -->
    <div class="container mb-xxl-11 mb-lg-10 mb-4">
      <div class="row g-xl-4 pt-5 pt-lg-0 g-4 justify-content-md-between align-items-center justify-content-center">
        ...
        <div class="col-xl-4 col-lg-4 col-md-5 col-sm-5">
          <VideoHowItWork :handle-video-modal="handleVideoModal" :isOpen="isOpen" :image="videoImage" />
        </div>
      </div>
    </div>
    <!-- {/* Section Header */} -->
      ...
      <div class="row g-lg-6 g-sm-10 g-15 justify-content-center">
        ...
        <MotionEffectMotionFade class="col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in" data-aos-duration="1700">
          <div class="work-item1 work-stepv5 text-center position-relative">
            ...
            <div class="box pt-xxl-20 pt-10">
              <h4 class="n4-clr mb-xxl-4 mb-3 fw_700">PROCEED TO CHECK OUT</h4>
              <p class="fs18 n3-clr">
                and wait for the winners to be
                <span class="d-block">announced to find out if you’ve won.</span>
              </p>
            </div>
          </div>
        </MotionEffectMotionFade>
