...
<template>
  <div class="real-estate-video real-bg d-center position-relative overflow-hidden">
        <div class="real-vid position-relative">
          <button class="popup-video real-play d-center" @click='handleVideoModal'>
            <PhPlay weight="fill" class="ti ti-player-play-filled n0-clr fs-three" />
          </button>
